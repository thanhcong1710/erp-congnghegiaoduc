      ...
      <div class="mb-5">
        ...
        <div class="vx-row mt-3">
          <div class="vx-col w-full">
            <router-link class="btn btn-success" :to="'/marketing/c2c/campaigns/add'">
            ...
            <table class="vs-table vs-table--tbody-table">
              ...
              <tr class="tr-values vs-table--tr tr-table-state-null" v-for="(item, index) in campaigns" :key="index">
                ...
                <td class="td vs-table--td text-center list-action">  
                    <router-link :to="`/marketing/c2c/campaigns/edit/${item.id}`">
  ...
  export default {
    ...
    methods: {
      ...
      getData() {
        ...
        this.$vs.loading()
        axios.p('/api/marketing/c2c/campaigns/list', data)
          .then((response) => {
