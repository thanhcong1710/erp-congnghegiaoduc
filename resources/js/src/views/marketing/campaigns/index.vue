      ...
      <div class="mb-5">
        <div class="vx-row">
          <div class="vx-col sm:w-1/4 w-full mb-4">
            ...
            <vs-input class="w-full" placeholder="Chiến dịch" v-model="searchData.keyword"></vs-input>
          </div>
          <div class="vx-col sm:w-1/4 w-full mb-4">
        ...
        <div class="vx-row mt-3">
          <div class="vx-col w-full">
            <router-link class="btn btn-success" :to="'/marketing/campaigns/add'">
            ...
            <table class="vs-table vs-table--tbody-table">
              <thead class="vs-table--thead">
                <tr>
                  ...
                  <th colspan="1" rowspan="1">Chiến dịch</th>
              ...
              <tr class="tr-values vs-table--tr tr-table-state-null" v-for="(item, index) in campaigns" :key="index">
                <!---->
                ...
                <td class="td vs-table--td text-center list-action"> 
                    <router-link :to="`/marketing/campaigns/detail/${item.id}`" >
                      <vs-button size="small"><i class="fa fa-eye"></i></vs-button>
                    </router-link> 
                    <router-link :to="`/marketing/campaigns/edit/${item.id}`">
  ...
  export default {
    ...
    methods: {
      ...
      getData() {
        ...
        this.$vs.loading()
        axios.p('/api/marketing/campaigns/list', data)
          .then((response) => {
