      ...
      <div class="mb-5">
        <div class="vx-row">
          <div class="vx-col sm:w-1/4 w-full mb-4">
            ...
            <vs-input class="w-full" placeholder="Mã voucher, tên chiến dịch" v-model="searchData.keyword"></vs-input>
          </div>
          <div class="vx-col sm:w-1/4 w-full mb-4">
            ...
            <table class="vs-table vs-table--tbody-table">
              <thead class="vs-table--thead">
                <tr>
                  ...
                  <th colspan="1" rowspan="1" class="text-center">Tên chiến dịch</th>
              ...
              <tr class="tr-values vs-table--tr tr-table-state-null" v-for="(item, index) in coupons" :key="index">
                ...
                <td class="td vs-table--td text-center">
                  <span v-if="item.status == 2"> Đã sử dụng</span>
                  <vs-switch v-else v-model="item.status" color="success" style="margin:auto" @change="updateStatus(item)"/>
                </td>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      updateStatus(data){
        axios.p('/api/marketing/coupons/update', data)
          .then((response) => {
      ...
      getData() {
        ...
        this.$vs.loading()
        axios.p('/api/marketing/coupons/list', data)
          .then((response) => {
            this.$vs.loading.close()
