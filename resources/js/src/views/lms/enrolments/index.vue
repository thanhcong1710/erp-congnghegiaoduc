                  ...
                  <table class="vs-table vs-table--tbody-table">
                    ...
                    <tr class="tr-values vs-table--tr tr-table-state-null" v-for="(item, index) in students" :key="index">
                      ...
                      <td class="td vs-table--td">
                        ...
                        <div>
                          <vs-button  v-if="item.left_sessions <=0 || item.contract_type==0" class="mr-3" style="padding: 5px 10px;" size="sm" color="danger" @click="withdrawContract(item)"><i class="fa-solid fa-x"></i></vs-button>
                          <vs-button v-if="item.left_sessions <=0 " class="mr-3"  style="padding: 5px 10px;" size="sm" color="success" @click="showJoinContract(item)"><i class="fa-solid fa-plus"></i></vs-button>
                        </div>
                      </td>
                    </tr>
                  </table>
