    ...
    <vx-card no-shadow class="mt-5">
          ...
          <div class="vx-row">
            ...
            <div class="vx-col md:w-1/2 w-full mb-4">
              ...
              <input
                ...
                type="text"
                name="title"
                :value="contract_info.discount_other | formatNumber"
                disabled="true"
              />
            </div>
            <vs-divider/>
      ...
      <div class="vx-row mt-5">
        <div class="vx-col w-full text-right">
          <router-link class="btn btn-danger" :to="`/lms/contracts-renew`">
            <vs-button color="dark" type="border" class="mb-2 mr-3" >Thoát</vs-button>
          </router-link>
          <router-link class="btn btn-danger" :to="`/lms/contracts-renew/${contract_info.contract_id}/edit`" v-if="contract_info.debt_amount > 0">
