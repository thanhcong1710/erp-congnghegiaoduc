<template>
  <div id="page-report-16">
    <div class="rpt-header">
      <div class="rpt-header__icon"><i class="fas fa-chart-pie"></i></div>
      <div>
        <h3 class="rpt-header__title">BÁO CÁO DOANH THU CHƯA PHÂN BỔ THEO TRUNG TÂM</h3>
        <p class="rpt-header__sub">Tổng hợp số tiền còn lại theo từng trung tâm</p>
      </div>
    </div>
