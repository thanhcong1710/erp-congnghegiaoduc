<template>
  <div id="page-report-13">
    <div class="rpt-header">
      <div class="rpt-header__icon"><i class="fas fa-dollar-sign"></i></div>
      <div>
        <h3 class="rpt-header__title">BÁO CÁO DOANH SỐ CHI TIẾT HỌC SINH ĐI HỌC</h3>
        <p class="rpt-header__sub">Thống kê doanh số theo từng buổi học sinh tham gia lớp</p>
      </div>
    </div>
