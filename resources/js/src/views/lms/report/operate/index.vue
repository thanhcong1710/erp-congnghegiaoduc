      ...
      <div class="mb-5">
        <div class="vx-row">
          <div class="vx-col w-full mb-4">
            ...
            <div class="mb-2">
              <router-link class="link-report" :to="'/lms/reports/operate/report-07'" v-if="checkPermission('lms_reports_operate_01')">
                <p>01. BÁO CÁO LỚP HỌC</p>
              </router-link>
            </div>
            <div class="mb-2">
              <router-link class="link-report" :to="'/lms/reports/operate/report-13'" v-if="checkPermission('lms_reports_operate_02')">
                <p>02. BÁO CÁO DOANH SỐ CHI TIẾT HỌC SINH ĐI HỌC</p>
              </router-link>
            </div>
            <div class="mb-2">
              <router-link class="link-report" :to="'/lms/reports/operate/report-14'" v-if="checkPermission('lms_reports_operate_03')">
                <p>03. BÁO CÁO TỔNG QUAN DOANH THU THEO TRUNG TÂM</p>
              </router-link>
            </div>
            <div class="mb-2">
              <router-link class="link-report" :to="'/lms/reports/operate/report-15'" v-if="checkPermission('lms_reports_operate_04')">
                <p>04. BÁO CÁO DOANH THU CHƯA PHÂN BỔ THEO HỌC SINH</p>
              </router-link>
            </div>
            <div class="mb-2">
              <router-link class="link-report" :to="'/lms/reports/operate/report-16'" v-if="checkPermission('lms_reports_operate_05')">
