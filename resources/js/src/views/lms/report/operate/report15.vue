<template>
  <div id="page-report-15">
    <div class="rpt-header">
      ...
      <div>
        <h3 class="rpt-header__title">BÁO CÁO DOANH THU CHƯA PHÂN BỔ THEO HỌC SINH</h3>
        <p class="rpt-header__sub">Danh sách contracts còn số tiền chưa phân bổ theo học sinh</p>
      </div>
    </div>
