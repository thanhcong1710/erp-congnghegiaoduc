...
<template>
  ...
  <div id="page-roles-list">
    <vx-card no-shadow class="mt-5">
      <h5>BÁO CÁO HỌC VIÊN ĐẶT CỌC</h5>
            ...
            <table class="vs-table vs-table--tbody-table" style="width: 1800px">
              <thead class="vs-table--thead">
                <tr>
                  ...
                  <th colspan="1" rowspan="1">Ngày đặt cọc</th>
                  <th colspan="1" rowspan="1">Số tiền đặt cọc</th>
                  <th colspan="1" rowspan="1">Số tiền còn lại chưa thanh toán</th>
