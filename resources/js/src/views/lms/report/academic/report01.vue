...
<template>
  ...
  <div id="page-roles-list">
    <vx-card no-shadow class="mt-5">
      <h5>BÁO CÁO CHI TIẾT GIỜ DẠY CỦA TRỢ GIẢNG</h5>
      ...
      <div class="mb-5">
        <div class="vx-row">
          ...
          <div class="vx-col sm:w-1/4 w-full mb-4">
            ...
            <vs-input class="w-full" placeholder="Mã trợ giảng, tên trợ giảng" v-model="searchData.keyword"></vs-input>
          </div>
          <div class="vx-col sm:w-1/4 w-full mb-4">
            ...
            <table class="vs-table vs-table--tbody-table" style="width: 1800px">
              <thead class="vs-table--thead">
                <tr>
                  ...
                  <th colspan="1" rowspan="1">Thời lượng (giờ)</th>
