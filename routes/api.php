...
Route::group(['middleware' => 'api'], function ($router) {
    ...
    Route::group(['middleware' => 'jwt.auth'], function ($router) {
        ...
        Route::prefix('lms')->group(function () {
            ...
            Route::post('agreements/load-classes-for-enrolment', 'ContractsController@loadClassesForEnrolment');
            ...
            Route::post('agreements/list-by-student', 'ContractsController@listByStudent');
            ...
            Route::post('agreements/change-contract-product', 'ContractsController@changeContractProduct');
            ...
            Route::prefix('reports')->group(function () {
                ...
                Route::post('16', 'ReportsController@report16');
                Route::post('17', 'ReportsController@report17');
                Route::post('18', 'ReportsController@report18');
                ...
                Route::post('23', 'ReportsController@report23');
                Route::post('24', 'ReportsController@report24');
                Route::post('28', 'ReportsController@report28');
                ...
                Route::post('teacher-payroll', 'TeacherPayrollController@list');
            });
            Route::prefix('exports')->group(function () {
                ...
                Route::get('report13/{key}/{value}', 'ExportsController@report13');
                Route::get('report14/{key}/{value}', 'ExportsController@report14');
                Route::get('report15/{key}/{value}', 'ExportsController@report15');
                Route::get('report16/{key}/{value}', 'ExportsController@report16');
                Route::get('report17/{key}/{value}', 'ExportsController@report17');
                Route::get('report18/{key}/{value}', 'ExportsController@report18');
                ...
                Route::get('report28/{key}/{value}', 'ExportsController@report28');
