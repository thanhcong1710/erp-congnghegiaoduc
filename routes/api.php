...
Route::group(['middleware' => 'api'], function ($router) {
    Route::post('partner/payment/info', 'PartnerController@getDataCreverse');
    ...
    Route::get('test-auto/{student_id}', 'JobsController@testAuto');
    Route::group(['middleware' => 'jwt.auth'], function ($router) {
        ...
        Route::prefix('lms')->group(function () {
            ...
            Route::post('checkin/add', 'CheckinController@add');
            ...
            Route::get('tuition_transfer/print/{contract_id}', 'TuitionTransfersController@print');
            ...
            Route::prefix('reports')->group(function () {
                ...
                Route::post('08', 'ReportsController@report08');
                Route::post('09', 'ReportsController@report09');
                Route::post('10', 'ReportsController@report10');
                Route::post('11', 'ReportsController@report11');

                Route::post('101', 'ReportsController@report101');
                Route::post('102', 'ReportsController@report102');
                Route::post('103', 'ReportsController@report103');
                Route::post('104', 'ReportsController@report104');

                Route::post('202', 'ReportsController@report202');
                Route::post('203', 'ReportsController@report203');
            });
            Route::prefix('exports')->group(function () {
                ...
                Route::get('report08/{key}/{value}', 'ExportsController@report08');
                Route::get('report09/{key}/{value}', 'ExportsController@report09');
                Route::get('report10/{key}/{value}', 'ExportsController@report10');
                Route::get('report11/{key}/{value}', 'ExportsController@report11');

                Route::get('report101/{key}/{value}', 'ExportsController@report101');
                Route::get('report102/{key}/{value}', 'ExportsController@report102');
                Route::get('report103/{key}/{value}', 'ExportsController@report103');
                Route::get('report104/{key}/{value}', 'ExportsController@report104');

                Route::get('report202/{key}/{value}', 'ExportsController@report202');
                Route::get('report203/{key}/{value}', 'ExportsController@report203');
            });
        });
        ...
        Route::prefix('dashboard')->group(function () {
            ...
            Route::post('13', 'DashboardController@dashboard13');
