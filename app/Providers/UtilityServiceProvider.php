...
class UtilityServiceProvider extends ServiceProvider
{
    ...
    public static function updateDoneSessions($contract_id)
    {
        ...
        $contract_info = self::first("SELECT id, product_id, branch_id, class_id, `status`, enrolment_start_date, summary_sessions,last_done_sessions, student_id, code FROM contracts WHERE id=$contract_id");
        if($contract_info){
